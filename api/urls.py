...
urlpatterns = [
    ...
    path(r'enviarNotificacion/', notification_views.enviar_notificacion, name='enviar_notificacion'),
    ...
    path(r'obtenerPreferencias/<int:usuario_id>/', user_views.obtener_preferencias, name='obtener_preferencias')
